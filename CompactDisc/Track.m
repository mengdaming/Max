...
- (AudioMetadata *) metadata
{
	...
	[result setTrackNumber:[NSNumber numberWithUnsignedInt:(unsigned int)[self number]]];
	...
	[result setTrackTotal:[NSNumber numberWithUnsignedInt:(unsigned int)[[self document] countOfTracks]]];
